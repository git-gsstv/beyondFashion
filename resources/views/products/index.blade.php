    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-beige-900 overflow-hidden shadow-xl shadow-beige-700/50 sm:rounded-lg p-6 text-beige-50">
                ...
                <a href="{{ route('products.create') }}" class="bg-beige-700 text-beige-50 px-4 py-2 rounded hover:bg-beige-800 transition mb-4 inline-block">
                    Novo Produto +
                </a>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-beige-700 hover:bg-beige-800/80 transition">
                            ...
                            <td class="p-2 flex gap-2">
                                <a href="{{ route('products.edit', $p) }}" class="text-beige-400 hover:text-beige-200">Editar</a>
                        ...
                        @empty
                        <tr>
                            <td colspan="4" class="p-2 text-center text-beige-500">
